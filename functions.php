...
function underscores_scripts() {
	...
	/**wp_enqueue_style( 'underscores-bootstrap-theme', get_template_directory_uri() . '/css/bootstrap-theme.min.css');*/
	wp_enqueue_style( 'underscores-css', get_template_directory_uri() . '/css/css.css');

	wp_enqueue_script( 'underscores-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	/**wp_enqueue_script( 'underscores-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '', true );
	*wp_enqueue_script( 'underscores-jquery', get_template_directory_uri() . '/js/jquery-1.11.2.min.js', array(), '', true );
	*wp_enqueue_script( 'underscores-javascript', get_template_directory_uri() . '/js/javascript.min.js', array(), '', true );
	*/
